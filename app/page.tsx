    ...
    <div className="flex flex-wrap p-4 justify-between md:justify-normal md:space-x-5.5 space-y-5.5 md:px-[135px]">
      {Tickets.map((el) => (
        <Link
          href={`/${el.key}`}
          key={el.key}
          className="transition-[0.7s] flex justify-center items-center bg-[black] w-[46%] h-[42vw] rounded-2xl md:w-[200px] md:h-[200px] hover:bg-[#1d1d1d] hover:text-[24px] hover:scale-105"
